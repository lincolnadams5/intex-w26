                  ...
                  <div className="px-3 pb-3 pt-2 border-t border-[var(--color-outline-variant)] flex flex-col gap-2.5">
                    {v.observations && (
                      <div>
                        ...
                        <p className="text-sm text-[var(--color-on-surface)] whitespace-pre-wrap">{v.observations}</p>
                      </div>
                    )}
                    <div>
                      <p className="text-xs text-[var(--color-on-surface-variant)] mb-0.5">Family Cooperation</p>
