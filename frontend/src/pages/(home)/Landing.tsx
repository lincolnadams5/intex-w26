...
import pagasaHeroWide from '../../assets/pagasa-hero-wide.png'
...
export function Landing() {
  return (
    <>
      ...
      style={{
        backgroundImage: `url(${pagasaHeroWide})`,
      ...
      <div className="relative flex-1 flex items-center py-12 md:py-16">
        ...
        <div className="max-w-2xl">
          ...
          <Link
            to="/donate"
            className="px-8 py-3 bg-[var(--color-secondary)] text-[var(--color-on-secondary)] font-semibold text-sm uppercase tracking-wider rounded hover:shadow-[0_12px_40px_rgba(0,76,90,0.2)] transition-all"
          >
            Empower a Survivor
          </Link>
          <a
